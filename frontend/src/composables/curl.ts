...
// cURL *generation* lives in useCodeGen.ts (generateCurl) so it shares the
// header/auth/Content-Type resolution with the other language snippets. This
// module keeps only the parser (Import → request fields).
