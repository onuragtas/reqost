...
func (s *ExecService) SendRequest(reqId string, req httpclient.Request, preScript, postScript string) (*SendResult, error) {
	...
	info := script.Info{RequestID: reqId, RequestName: ""}
